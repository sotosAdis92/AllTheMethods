...
import discretenewtonraphson from "../../assets/dnr.png";
...
import rungekutta from "../../assets/runge.png";
...
const ProblemTypeImage = (props) => {
  if (props.type === "Bisection") {
    ...
    return <img src={discretenewtonraphson} className="imageType"></img>;
    ...
    return <img src={rungekutta} className="imageType"></img>;
